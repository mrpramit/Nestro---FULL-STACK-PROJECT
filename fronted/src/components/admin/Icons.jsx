...
export const AiIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const TaskIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const FormsIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const TablesIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const PagesIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const LayoutIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const ArrowRightIcon = ({ className = "w-4 h-4", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const LogoIcon = ({ className = "w-8 h-8", ...props }) => (
  ...
  >
    ...
    <line x1="9" y1="17" x2="9" y2="8" strokeWidth="3" />
    <line x1="15" y1="17" x2="15" y2="12" strokeWidth="3" />
  </svg>
);

export const CategoryIcon = ({ className = "w-4 h-4", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const ProductIcon = ({ className = "w-4 h-4", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const RoomIcon = ({ className = "w-4 h-4", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
